    ...
    <div className="min-h-screen bg-[#1a1023]">
      ...
      <main className="lg:ml-[200px] min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          <div className="w-16 h-16 rounded-2xl bg-[#FB923C]/15 flex items-center justify-center mx-auto mb-5">
            <Truck size={28} className="text-[#FB923C]" />
          </div>
          <h1 className="text-2xl font-bold text-[#faf5ff] mb-2">Pengiriman</h1>
