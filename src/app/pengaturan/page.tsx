  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface-primary px-4">
      <div className="text-center max-w-md">
        <div className="w-16 h-16 rounded-2xl bg-content-tertiary/10 flex items-center justify-center mx-auto mb-5">
          <Settings size={28} className="text-content-secondary" />
        </div>
