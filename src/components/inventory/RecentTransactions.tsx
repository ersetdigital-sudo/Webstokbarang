  ...
  return (
    <div className="rounded-xl border border-border bg-card">
      ...
      <div className="divide-y divide-border">
        {transactions.map((t) => (
          <div key={t.id} className="flex items-center gap-3 px-5 py-3.5 hover:bg-muted/50 transition-colors">
            ...
            <div className="text-right">
              <p className={`text-sm font-mono font-medium ${t.type === "masuk" ? "text-success" : "text-destructive"}`}>{t.type === "masuk" ? "+" : "-"}{t.qty}</p>
