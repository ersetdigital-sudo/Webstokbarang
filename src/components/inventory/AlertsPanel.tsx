  ...
  return (
    <div className="bg-gradient-to-br from-[#131313] to-[#0f0f0f] border border-white/[0.07] rounded-xl overflow-hidden">
      ...
      <div className="divide-y divide-white/[0.04]">
        {alerts.map((a) => (
          <div key={a.id} className={`flex items-center gap-3 px-5 py-4 hover:bg-white/[0.02] transition-colors ${a.type === "critical" ? "border-l-2 border-l-red-500/40" : ""}`}>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${a.type === "critical" ? "bg-red-500/12" : "bg-amber-500/8"}`}>
              {a.type === "critical" ? (
